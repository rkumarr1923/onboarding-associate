    ...
    return <Form.Group as={Col} md={md} controlId={controlId}>
        ...
        <div className="date-picker-element">
            <DatePicker
                ...
                todayButton={"TODAY"}
                className={valid ? "form-control form-style" : "form-control is-invalid"}
            />
        <span className="fa fa-calendar calendar-element"></span>
        </div>
        <Form.Control.Feedback type="invalid" className="col-md-6 d-inline-block px-0">{!valid ? `${label} is incorrect` : ""}</Form.Control.Feedback>
    </Form.Group>
}
